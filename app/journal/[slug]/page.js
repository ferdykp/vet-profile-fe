  ...
  return <>
      <article className="pt-2.5">
        <header className="w-[min(1280px,_calc(100%_-_96px))] my-0 mx-auto pt-7.5 pb-8 [&_h1]:max-w-270 [&_h1]:text-[clamp(32px,_4vw,_52px)] [&_h1]:leading-[1.12] [&_h1]:mt-2.5 [&_h1]:mb-3 [&_h1]:mx-0 max-[1020px]:w-[min(100%_-_48px,_1280px)] max-[800px]:w-[min(100%_-_32px,_1280px)] max-[560px]:w-[min(100%_-_24px,_1280px)] max-[560px]:[&_h1]:text-[39px]">
          ...
          <h1>{post.title}</h1>
          <p className="max-w-225 font-(family-name:--font-serif) italic text-[22px] leading-[1.5] text-[#424844] max-[560px]:text-[19px]">“{post.excerpt}”</p>
        ...
        <section className="w-[min(1280px,_calc(100%_-_96px))] my-0 mx-auto grid grid-cols-[minmax(0,_8fr)_minmax(230px,_4fr)] gap-17.5 items-start max-[1020px]:w-[min(100%_-_48px,_1280px)] max-[800px]:w-[min(100%_-_32px,_1280px)] max-[800px]:grid-cols-1 max-[560px]:w-[min(100%_-_24px,_1280px)]">
          <div className="max-w-205">
            <BlockContent content={post.content} />
            {!post.content && <div className="text-[17px] leading-[1.85] text-[#1b1c18] [&_>_p:first-child:first-letter]:float-left [&_>_p:first-child:first-letter]:mt-[3px] [&_>_p:first-child:first-letter]:mr-2 [&_>_p:first-child:first-letter]:mb-0 [&_>_p:first-child:first-letter]:ml-0 [&_>_p:first-child:first-letter]:font-(family-name:--font-serif) [&_>_p:first-child:first-letter]:text-[58px] [&_>_p:first-child:first-letter]:leading-[0.78] [&_>_p:first-child:first-letter]:text-[#14261d] [&_p]:mt-0 [&_p]:mb-[21px] [&_p]:mx-0 [&_h2]:text-[31px] [&_h2]:mt-11.5 [&_h2]:mb-3.5 [&_h2]:mx-0 [&_h3]:text-[23px] [&_h3]:mt-8.5 [&_h3]:mb-[11px] [&_h3]:mx-0 [&_blockquote]:my-[35px] [&_blockquote]:mx-0 [&_blockquote]:py-2 [&_blockquote]:pr-0 [&_blockquote]:pl-5.5 [&_blockquote]:border-l-2 [&_blockquote]:border-l-[#c9866b] [&_blockquote]:font-(family-name:--font-serif) [&_blockquote]:text-[23px] [&_blockquote]:leading-[1.5] [&_blockquote]:italic [&_blockquote]:text-[#14261d] [&_figure]:my-8.5 [&_figure]:mx-0 [&_figure_img]:w-full [&_figure_img]:rounded-[10px] [&_figcaption]:mt-[7px] [&_figcaption]:text-[12px] [&_figcaption]:text-[#59625b] [&_ol]:pl-6 [&_ol]:my-5 [&_ol]:mx-0 [&_ul]:pl-6 [&_ul]:my-5 [&_ul]:mx-0 [&_li]:my-[9px] [&_li]:mx-0 [&_li]:pl-1.5">
                <p>{post.excerpt}</p>
          ...
          <aside className="flex flex-col gap-4.5 sticky top-[105px] [&_>_div]:p-4.5 [&_>_div]:bg-[#f5f3ed] [&_>_div]:rounded-[8px] [&_>_div]:border-l-2 [&_>_div]:border-l-[#c9866b] [&_span]:text-[12px] [&_span]:uppercase [&_span]:tracking-[0.09em] [&_span]:text-[#526a5a] [&_span]:font-bold [&_p]:text-[12px] [&_p]:leading-[1.6] [&_p]:text-[#424844] [&_a]:text-[12px] [&_a]:leading-[1.6] [&_a]:text-[#526a5a] [&_a]:inline-block [&_a]:mr-1.5 max-[800px]:static max-[800px]:-order-1">
            <div>
