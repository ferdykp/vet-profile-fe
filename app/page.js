...
export default async function Home() {
  ...
  return <>
      <section className="w-[min(1280px,_calc(100%_-_96px))] my-0 mx-auto pt-7 pb-18 max-[1020px]:w-[min(100%_-_48px,_1280px)] max-[800px]:w-[min(100%_-_32px,_1280px)] max-[800px]:pt-6 max-[800px]:pb-12 max-[560px]:w-[min(100%_-_24px,_1280px)]">
        ...
        <div className="grid grid-cols-[minmax(0,_1.35fr)_minmax(330px,_0.65fr)] gap-20.5 items-center max-[1020px]:grid-cols-[1fr_0.75fr] max-[1020px]:gap-10.5 max-[800px]:grid-cols-1 max-[800px]:gap-7.5">
          <div className="py-3.5 px-0 [&_h1]:max-w-195 [&_h1]:mt-3.5 [&_h1]:mb-4.5 [&_h1]:mx-0 [&_h1]:text-[clamp(36px,_4.4vw,_56px)] [&_h1]:leading-[1.08] [&_>_p]:max-w-190 [&_>_p]:text-[#424844] [&_>_p]:text-[16px] [&_>_p]:leading-[1.75] max-[560px]:[&_h1]:text-[36px] max-[560px]:[&_>_p]:text-[15px]">
            ...
            <div className="flex items-center gap-4 w-[min(760px,_100%)] mt-6.5 mb-4.5 mx-0 py-3 px-3.5 bg-[#f0eee8] rounded-[8px] text-[12px] text-[#59625b] [&_strong]:font-(family-name:--font-serif) [&_strong]:text-[16px] [&_strong]:text-[#14261d] [&_strong]:font-medium max-[560px]:items-start max-[560px]:flex-col max-[560px]:gap-[5px]">
            ...
            <div className="flex gap-2.5 max-[560px]:flex-col">
              <Link href="/journal" className="inline-flex items-center justify-center gap-3 min-h-11 py-0 px-4 rounded-[7px] border border-transparent text-[14px] font-bold tracking-[0.04em] uppercase transition-all duration-200 ease-[ease] bg-[#293c32] text-[#fff] hover:-translate-y-px hover:bg-[#14261d]" data-ui="button primary">
                Explore the Journal <span><Icon name="external" className="size-5" /></span>
              </Link>
              <Link href="/about" className="inline-flex items-center justify-center gap-3 min-h-11 py-0 px-4 rounded-[7px] border border-transparent text-[14px] font-bold tracking-[0.04em] uppercase transition-all duration-200 ease-[ease] bg-[#f0eee8] text-[#14261d] hover:bg-[#eae8e2]" data-ui="button subtle">
          ...
          <div className="flex justify-center max-[800px]:justify-start">
            <div className="w-[min(100%,_420px)] p-[7px] rounded-[6px] bg-[#fff] shadow-[0_8px_20px_rgba(20,_38,_29,_0.12)] [&_>_img]:w-full [&_>_img]:aspect-[1.05/1] [&_>_img]:object-cover max-[800px]:w-[min(100%,_520px)]">
              ...
              <div className="grid grid-cols-[1fr_auto] gap-[3px_12px] items-center pt-2.5 pb-[5px] px-2 text-[12px] [&_>_div]:flex [&_>_div]:items-center [&_>_div]:gap-1.5 [&_strong]:font-semibold [&_small]:text-[#59625b] [&_small]:col-start-1 [&_>_span]:col-start-2 [&_>_span]:row-start-1 [&_>_span]:row-end-3 [&_>_span]:text-[#526a5a]">
                <div>
      ...
      <section className="bg-[#f5f3ed] border-t border-t-[#526a5a]/8 border-b border-b-[#526a5a]/8">
        <div className="w-[min(1280px,_calc(100%_-_96px))] my-0 mx-auto grid grid-cols-[0.75fr_1.55fr] gap-25 py-16 max-[1020px]:w-[min(100%_-_48px,_1280px)] max-[1020px]:gap-[55px] max-[800px]:w-[min(100%_-_32px,_1280px)] max-[800px]:grid-cols-1 max-[800px]:gap-7.5 max-[800px]:py-12 max-[560px]:w-[min(100%_-_24px,_1280px)]">
          ...
          <div className="[&_blockquote]:mt-0 [&_blockquote]:mb-8.5 [&_blockquote]:mx-0 [&_blockquote]:font-(family-name:--font-serif) [&_blockquote]:text-[23px] [&_blockquote]:leading-[1.45] [&_blockquote]:italic [&_blockquote]:text-[#14261d]">
            <blockquote>
      ...
      {featured && <section className="w-[min(1280px,_calc(100%_-_96px))] my-0 mx-auto py-18 max-[1020px]:w-[min(100%_-_48px,_1280px)] max-[800px]:w-[min(100%_-_32px,_1280px)] max-[560px]:w-[min(100%_-_24px,_1280px)]">
          ...
          <article className="grid grid-cols-[1.3fr_0.9fr] min-h-97.5 rounded-[10px] overflow-hidden bg-[#f0eee8] shadow-[0_4px_14px_rgba(41,_60,_50,_0.06)] [&:hover_img]:scale-102 max-[800px]:grid-cols-1">
            <Link href={`/journal/${featured.slug}`} className="relative min-h-97.5 overflow-hidden [&_img]:w-full [&_img]:h-full [&_img]:object-cover [&_img]:transition-all [&_img]:duration-500 [&_img]:ease-[ease] [&_>_span]:absolute [&_>_span]:left-3 [&_>_span]:top-3 [&_>_span]:py-[5px] [&_>_span]:px-2 [&_>_span]:bg-[#5a2b16] [&_>_span]:rounded-full [&_>_span]:text-[#fff] [&_>_span]:text-[12px] [&_>_span]:tracking-[0.08em] [&_>_span]:uppercase max-[800px]:min-h-75">
            ...
            <div className="p-8 flex flex-col justify-between [&_h3]:mt-2.5 [&_h3]:mb-3 [&_h3]:mx-0 [&_h3]:text-[34px] [&_h3]:leading-[1.12] [&_>_p]:text-[15px] [&_>_p]:leading-[1.7] [&_>_p]:text-[#424844]">
              ...
              <div className="mt-6 pt-4 border-t border-t-[#d5ddd3] grid grid-cols-[34px_1fr_auto] gap-2.5 items-center [&_div]:flex [&_div]:flex-col [&_b]:text-[12px] [&_small]:text-[12px] [&_small]:text-[#59625b] [&_small]:mt-0.5 [&_>_a]:w-7 [&_>_a]:h-7 [&_>_a]:rounded-full [&_>_a]:grid [&_>_a]:place-items-center [&_>_a]:bg-[#fbf9f3] [&_>_a]:text-[15px]">
                <span className="w-7.5 h-7.5 rounded-full grid place-items-center bg-[#14261d] text-[#fff] font-(family-name:--font-serif) text-[12px]">EV</span>
                <div>
      ...
      <section className="w-[min(1280px,_calc(100%_-_96px))] my-0 mx-auto py-18 max-[1020px]:w-[min(100%_-_48px,_1280px)] max-[800px]:w-[min(100%_-_32px,_1280px)] max-[560px]:w-[min(100%_-_24px,_1280px)]">
        ...
        <div className="grid grid-cols-[repeat(3,_1fr)] gap-4.5 max-[800px]:grid-cols-1">
          {(d.featured_resources || []).slice(0, 3).map((r, i) => <a key={r.id} href={safeUrl(r.url, "/resources")} className="min-h-67.5 p-5 rounded-[8px] bg-[#f5f3ed] border border-[#526a5a]/8 transition-all duration-200 ease-[ease] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_-4px_rgba(41,_60,_50,_0.07)] [&_small]:text-[11px] [&_small]:uppercase [&_small]:tracking-[0.07em] [&_small]:text-[#59625b] [&_h3]:text-[21px] [&_h3]:leading-[1.1] [&_h3]:mt-[7px] [&_h3]:mb-2.5 [&_h3]:mx-0 [&_p]:text-[13px] [&_p]:leading-[1.6] [&_p]:text-[#424844] [&_>_b]:block [&_>_b]:mt-4.5 [&_>_b]:text-[11px] [&_>_b]:uppercase [&_>_b]:tracking-[0.07em] [&_>_b]:text-[#526a5a]">
